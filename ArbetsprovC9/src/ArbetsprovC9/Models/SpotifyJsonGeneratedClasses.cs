...
{
    public class SpotifyJsonGeneratedClasses
    {
    }
    ...
    public class ArtistsWhenSearch
    {
        public string href { get; set; }
    ...
    public class RootObjectSearchResult
    {
        public ArtistsWhenSearch artists { get; set; }
    }
    ...
    public class Track
    {
        ...
        public List<ArtistFromTrack> artists { get; set; }
    ...
    public class RootObjectTrackList
    {
        public List<Track> tracks { get; set; }
    }

    public class RootObjectRelatedArtist
    {
